		...
		cargarButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (existeArchivoGuardado()) {
					Juego juegoExistente = new Juego(null, cantidadDeHabitaciones); // Crear una instancia de Juego
																					// existente
					Juego juegoCargado = Juego.cargarPartida(juegoExistente); // Cargar la partida en la instancia
																				// existente
